...
│                                                                          │
│  ┌──────────────────┐     ┌──────────────────┐                         │
│  │  prdx-ansible101 │     │  prdx-dns101     │                         │
│  │   10.31.3.10    │     │   10.31.3.11    │                         │
│  │   Ansible Ctrl   │     │   BIND DNS      │                         │
│  │   Jenkins       │     │                 │                         │
│  │   Terraform     │     │                 │                         │
│  └────────┬─────────┘     └────────┬─────────┘                         │
│           │                        │                                     │
...
│                                                                          │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐               │
│  │ prdx-web101  │  │ prdx-web102  │  │ prdx-web103  │               │
│  │  10.31.3.21 │  │  10.31.3.22 │  │  10.31.3.23 │               │
...
│                                                                          │
│  ┌──────────────────┐        ┌──────────────────┐                         │
│  │  prdx-db101     │        │ prdx-dprimary101 │                         │
│  │   10.31.3.12   │        │   10.31.3.50    │                         │
│  │    MariaDB      │        │     Docker       │                         │
│  │                 │        │   Port 8888      │                         │
│  └──────────────────┘        └──────────────────┘                         │
│                                                                          │
│  ┌──────────────────┐        ┌──────────────────┐                         │
│  │ prdx-nagios101 │        │ prdx-kube101    │                         │
│  │   10.31.3.40  │        │   10.31.3.60   │                         │
│  │    Nagios      │        │   Minikube      │                         │
│  │   Port 80     │        │   Kubernetes    │                         │
│  └──────────────────┘        └──────────────────┘                         │
│                                                                          │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│    Git Push ──▶ Jenkins ──▶ Terraform Plan ──▶ Terraform Apply           │
│       │                                              │                   │
│       │                                              ▼                   │
│       │                                    Ansible Playbooks               │
│       │                                              │                   │
...
│       │           │                                 │                │  │
│       ▼           ▼                                 ▼                ▼  │
│    Checkout   Base Security    DNS    Web Servers   Database   Monitoring  │
│       │                                                                     │
│       ▼                                                                     │
│    Docker Build & Push                                                    │
│       │                                                                     │
